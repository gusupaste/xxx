  ...
  <div class="schoolCalendarList wrap">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer" style="margin-top:0">
        ...
        <el-button type="primary" style="background-color:#8bc34a;color:#fff;border-color:#8bc34a"
                   @click="addNewTemplate('addform')">保 存
        </el-button>
      </div>
    </el-dialog>
    <!-- 添加学校 -->
      ...
      searchSchoolList() {
        ...
        this.$axios.get('/api/school_calendar/select/center_list/', {
          ...
          _this.schoolList.map((v) => {
            ...
            _this.$set(_this.checkSchoolList, v.id, [])
          })
        }).catch(err => {
