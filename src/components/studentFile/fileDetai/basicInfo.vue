  ...
  <div class="basicInfo  clearfix">
    <div class="clearfix">
      <div class="text-align-center left">
        ...
        <el-form :model="studentInfo" :rules="rules" ref="studentInfo" class="demo-ruleForm" inline=""
          ...
          <el-form-item label="入园日期：" prop="enter_date" label-width="150px" style="text-align:left">
            <el-date-picker type="date" value-format="yyyy-MM-dd" placeholder="选择首次缴费日期" class="w250_input"
                            v-model="studentInfo.enter_date" style="width: 100%;"></el-date-picker>
          </el-form-item>
          <el-form-item label="首次缴费日期：" label-width="150px" style="text-align:left">
            <el-date-picker type="date" value-format="yyyy-MM-dd" placeholder="选择首次缴费日期" class="w250_input"
                            v-model="studentInfo.first_pay_date" style="width: 100%;"></el-date-picker>
          </el-form-item>
          <br>
          ...
          <el-form-item label="出生日期：" prop="date_of_birth" label-width="150px" class="w250_input">
            <el-date-picker type="date" value-format="yyyy-MM-dd" placeholder="请选择出生日期"
                            v-model="studentInfo.date_of_birth" style="width: 100%;"></el-date-picker>
          </el-form-item>
          ...
          <el-form-item label="家庭住址：" prop="address" label-width="150px" class="enroll-info">
            <el-select class="select-region" v-model="p_city_id" placeholder="省" @change="proinit(1)">
              <el-option v-for="pro in provinceList" :label="pro.city_name" :value="pro.city_id"
                         :key="pro.id"></el-option>
            </el-select>
            <el-select class="select-region" v-model="c_city_id" placeholder="市" @change="proinit(2)">
              <el-option v-for="city in cityList" :label="city.city_name" :value="city.city_id"
                         :key="city.id"></el-option>
            </el-select>
            <el-select class="select-region" v-model="town" placeholder="区">
              <el-option v-for="town in townList" :label="town.city_name" :value="town.city_id"
                         :key="town.id"></el-option>
            </el-select>
            <el-input v-model="studentInfo.address" style="width: auto;" placeholder="请输入详细地址"
