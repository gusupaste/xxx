  ...
  <div class="discountlist wrap">
    ...
    <div class="content">
      <div class="select-header">
        ...
        <span class="padding-left-30"><el-button type="primary" @click="getStudentInfo(1)">搜索</el-button></span>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      getStudentInfo: function (val) {
        ...
        var url = this.getList_url + d_type + '&type=' + this.type + '&center_id=' + this.school +
