<template>
  <div class="leaveStudent wrap">
    ...
    <add-student v-if="addStudentVisible" :status="status"></add-student>
  </div>
</template>
<style scoped>
  .leaveStudent .content-top{
    font-weight: 600;
  ...
  .leaveStudent .card-type {
    line-height: 30px;
  }
  .leaveStudent .el-card__body {
    padding: 30px 70px 10px 70px;
  }
  .leaveStudent .tableList {
    color:#101010;
  }
  .leaveStudent hr {
    margin: 10px 0;
