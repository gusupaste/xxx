<template>
  <div class="basicInfoStudent  clearfix">
    <div class="clearfix">
...
<style scoped>
  .basicInfoStudent .speciality >>> .el-textarea__inner {
    width: 800px;
    min-height: 150px !important;
  }
  .basicInfoStudent >>> .avatar-uploader .el-upload {
  ...
  .basicInfoStudent >>> .avatar-uploader .el-upload:hover {
    border-color: #409EFF;
  }
  .basicInfoStudent >>> .avatar-uploader-icon {
    font-size: 28px;
    color: #8c939d;
    width: 178px;
    height: 220px;
    ...
    watch: {
      ...
      activeName: {
        handler(newValue, oldValue) {
          if(newValue === 'first' || localStorage.getItem('studentTabName') === 'first'){
            this.getOptions();
            this.getCountryOptions();
            this.getIntercity_list();
            this.getYearList();
