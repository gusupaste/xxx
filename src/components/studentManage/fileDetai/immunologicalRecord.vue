<template>
    <div class="immunologicalRecordStudent">
        <p>免疫记录：</p>
        <el-table
        class="mt26"
            :data="tableList"
      ...
      <el-dialog title="确认删除" :visible.sync="deleteVisible" width="400px">
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button class="bg-green bd-green white" type="success" @click="deletePre">确 定</el-button>
        </span>
      </el-dialog>
    </div>
</template>
<style scoped>
    .immunologicalRecordStudent .recordHead {
    ...
    .immunologicalRecordStudent >>> .el-input__inner{
      width: auto;
    }
</style>
<script>
export default {
    ...
    mounted:function(){
      if(localStorage.getItem('studentTabName') === 'third'){
        this.getList();
      }
    },
    watch:{
